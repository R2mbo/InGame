      ...
      <section className="text-black min-h-screen flex justify-center flex-wrap gap-7 p-6">
        ...
        {!loading && currentGames.length > 0 ? (
          currentGames.map((game) => (
            <div
              key={game.id}
              className="bg-gray-950 py-3 hover:scale-105 border-2 border-orange-500 rounded-md transition-all duration-[0.4s] space-y-3 min-h-[440px] rounded-md group"
            >
              ...
              <a
                ...
                className="bg-orange-500 font-bold md:text-lg ml-2 block w-fit text-gray-950 hover:text-orange-500 hover:bg-gray-950 border-2 border-orange-500 md:px-2 rounded-md p-1 mt-9 mx-auto"
              >
                More Info ?
              </a>
            </div>
